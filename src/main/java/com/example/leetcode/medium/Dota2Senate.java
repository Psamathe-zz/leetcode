...
public class Dota2Senate {
    ...
    public String predictPartyVictory(String senate) {
        ...
        while (true) {
            ...
            senate = stack.stream().map(String::valueOf).collect(Collectors.joining());
            if(!stack.contains('D') || !stack.contains('R'))
                break;
            stack.clear();
        }
     ...
     * @return
     */
    public String predictPartyVictoryV3(String senate) {
