 ...
 * 0 <= k <= 107
 */
public class KDiffPairsnArray {
    public static void main(String[] args) {
        int[] nums = new int[]{1,3,1,5,4};
        int k = 0;
        KDiffPairsnArray kDiffPairsnArray = new KDiffPairsnArray();
        kDiffPairsnArray.findPairs(nums,k);
    }

    /**
     * https://www.cnblogs.com/grandyang/p/6545075.html
     * @param nums
     * @param k
     * @return
     */
