 ...
 */
public class AllAncestorsNodeInDirectedAcyclicGraph {
    public static void main(String[] args) {

    }

    /**
     * https://leetcode-cn.com/problems/all-ancestors-of-a-node-in-a-directed-acyclic-graph/solution/ha-xi-biao-dfs-by-allen-xl-ukpj/
     * @param n
     * @param edges
     * @return
     */
