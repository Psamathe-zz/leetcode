package com.example.leetcode.weeklycontest.old.test217;
...
public class MinimizeDeviationArray {
    public static void main(String[] args) {
        ...
        MinimizeDeviationArray minimizeDeviationArray = new MinimizeDeviationArray();
        minimizeDeviationArray.minimumDeviation(nums);
    }
