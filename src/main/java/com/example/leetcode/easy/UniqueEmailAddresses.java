...
public class UniqueEmailAddresses {
    public static void main(String[] args) {
        String[] emails = new String[]{"test.email@leetcode.com","testemail1@leetcode.com","testemail+david@lee.tcode.com"};
        UniqueEmailAddresses uniqueEmailAddresses = new UniqueEmailAddresses();
        uniqueEmailAddresses.numUniqueEmails(emails);
    }
    ...
    public String getMail(String email){
        ...
        String[] pre = list[0].split("\\+");
        String s = pre[0].replaceAll("\\.","");
        return s + "@" + list[1];
    }
